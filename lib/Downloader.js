...
var imagemin = __importStar(require("imagemin"));
...
var imageminOptions = {
    plugins: [
        ...
        imagemin_pngquant_1.default({ speed: 9 }),
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, imagemin.buffer(resp.data, imageminOptions)];
                        case 2:
                            compressed = _a.sent();
