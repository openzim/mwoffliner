...
var Zim = /** @class */ (function () {
    function Zim(config, args) {
        ...
        // Normalize
        this.outputDirectory = this.outputDirectory ? expand_home_dir_1.default(this.outputDirectory) + "/" : path_2.default.join(__dirname, '../', 'out/'); // '../' because __dirname is project/lib
        this.tmpDirectory = this.tmpDirectory ? expand_home_dir_1.default(this.tmpDirectory) + "/" : path_2.default.join(__dirname, '../', 'tmp/');
    }
