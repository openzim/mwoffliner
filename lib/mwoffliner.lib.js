            ...
            var cssPromises = config_1.default.output.cssResources
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            cssCont = _a.sent();
                            return [4 /*yield*/, zimCreator.addArticle(cssPath(css).replace('s/', ''), 's', cssCont)];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 4];
                        case 3:
            ...
            var jsPromises = config_1.default.output.jsResources.map(function (js) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            jsCont = _a.sent();
                            return [4 /*yield*/, zimCreator.addArticle(jsPath(js).replace('j/', ''), 'j', jsCont)];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 4];
                        case 3:
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, zimCreator.addArticle(jsPath('jsConfigVars').replace('j/', ''), 'j', jsConfigVars)];
                                    case 2:
                                        // fs.writeFileSync(pathParser.resolve(env.htmlRootPath, jsPath('jsConfigVars')), jsConfigVars);
                                        _c.sent();
                                        return [3 /*break*/, 4];
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 1:
                                                ...
                                                return [4 /*yield*/, zimCreator.addArticle(articleId_1, type === 'js' ? 'j' : 's', text)];
                                            case 2:
                                                _a.sent();
                ...
                var downloadCSSQueue = async_1.default.queue(function (link, finished) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 3:
                                cssContent = _a.sent();
                                return [4 /*yield*/, zimCreator.addArticle("style.css", 's', cssContent)];
                            case 4:
                                _a.sent();
                                finished();
                                _a.label = 5;
