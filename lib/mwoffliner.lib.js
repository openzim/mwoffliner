...
function execute(argv) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        function readTemplate(t) {
            return fs_1.default.readFileSync(path_1.default.resolve(process.cwd(), 'lib', t), 'utf-8');
        }
        ...
        function saveArticles(dump) {
            return new Promise(function (resolve, reject) {
                    ...
                    function buildArticleFromApiData() {
                        if (html) {
                            ...
                            prepareAndSaveArticle(html, articleId, function (error) {
                                ...
                                finished(error && { message: "Error preparing and saving file", error: error });
                            });
                        }
                        else {
                ...
                async_1.default.eachLimit(Object.keys(articleIds), speed, saveArticle, function (error) {
                    if (error) {
                        reject({ message: "Unable to retrieve an article correctly", error: error });
                    }
                    else {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 15:
                    _a.sent();
                    if (!skipCacheCleaning) return [3 /*break*/, 17];
                ...
                case 18:
                    _a.sent();
                    _a.label = 19;
                case 19: return [4 /*yield*/, redis.flushDBs()];
                case 20:
                    _a.sent();
