...
<div style="clear:both; background-image:linear-gradient(180deg, #E8E8E8, white); border-top: dashed 2px #AAAAAA; padding: 0.5em 0.5em 2em 0.5em; margin-top: 1em; direction: ltr;">
    ...
    Additional terms may apply for the media files.
        ...
        var cssLinks = config.output.cssResources.reduce(function(buf, css) {
                return buf + `<link href="${styleDirectory}/${styleModulesDirectory}/${css}" rel="stylesheet" type="text/css" />`
            }, '');
            ...
            config.output.cssResources.forEach(function(css) {
                try {
                    fs.readFile(pathParser.resolve(__dirname, "../" + css), (err, data) =>
                        fs.writeFile(pathParser.resolve(htmlRootPath, `${styleDirectory}/${styleModulesDirectory}/${css}`), data, () => {})
                    )
                } catch (error) {
