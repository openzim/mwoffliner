...
function execute(argv) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        function saveArticles(dump, finished) {
            ...
            function storeDependencies(parsoidDoc, articleId, finished) {
                ...
                node_fetch_1.default(articleApiUrl, {
                    ...
                    styleDependenciesList = styleDependenciesList.filter(function (oneStyleDep) { return U.contains(config_1.default.filters.blackListCssModules, oneStyleDep); });
        ...
        var _speed, adminEmail, localParsoid, customZimFavicon, verbose, minifyHtml, skipHtmlCache, skipCacheCleaning, keepEmptyParagraphs, mwUrl, mwWikiPath, mwApiPath, mwDomain, mwUsername, mwPassword, requestTimeout, publisher, articleList, customMainPage, customZimTitle, customZimDescription, customZimTags, cacheDirectory, mobileLayout, outputDirectory, tmpDirectory, withZimFullTextIndex, format, filenamePrefix, keepHtml, resume, deflateTmpHtml, writeHtmlRedirects, _addNamespaces, parsoidUrl, cpuCount, speed, logger, mw, downloader, hostParts, creator, wmProjects, zimOpts, zim, env, INFINITY_WIDTH, articleIds, webUrlHost, parsoidContentType, addNamespaces, optBinaries, redis, dirs, cssLinks, jsScripts, redirectTemplate, footerTemplate, leadSectionTemplate, sectionTemplate, subSectionTemplate, genericJsModules, genericCssModules, mediaRegex, htmlMobileTemplateCode, htmlDesktopTemplateCode, optimizationQueue, downloadFileQueue, redirectQueue;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    hostParts = url_1.default.parse(mw.base).hostname.split('.');
                    creator = hostParts[0];
