...
function execute(argv) {
    return __awaiter(this, void 0, void 0, function () {
            ...
            return new Promise(function (resolve, reject) {
                ...
                function saveArticle(articleId, finished) {
                    ...
                    if (zim.mobileLayout && zim.mainPageId !== articleId) {
                        ...
                        logger.info("Getting (desktop) article from " + articleUrl_1);
        ...
        var _speed, adminEmail, localParsoid, customZimFavicon, verbose, minifyHtml, skipHtmlCache, skipCacheCleaning, keepEmptyParagraphs, mwUrl, mwWikiPath, mwApiPath, mwDomain, mwUsername, mwPassword, requestTimeout, publisher, articleList, customMainPage, customZimTitle, customZimDescription, customZimTags, cacheDirectory, mobileLayout, outputDirectory, tmpDirectory, withZimFullTextIndex, format, filenamePrefix, keepHtml, resume, deflateTmpHtml, writeHtmlRedirects, _addNamespaces, parsoidUrl, cpuCount, speed, logger, nodeVersionSatisfiesPackage, mw, downloader, creator, zimOpts, zim, env, INFINITY_WIDTH, articleIds, webUrlHost, parsoidContentType, addNamespaces, redis, dirs, cssLinks, jsScripts, redirectTemplate, footerTemplate, leadSectionTemplate, sectionTemplate, subSectionTemplate, genericJsModules, genericCssModules, mediaRegex, htmlMobileTemplateCode, htmlDesktopTemplateCode, optimizationQueue, downloadFileQueue, redirectQueue;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
