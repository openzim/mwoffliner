        ...
        function saveArticles( finished ) {
            ...
            function storeDependencies( parsoidDoc, articleId, finished ) {
                ...
                .then(json => {
                    ...
                    jsDependenciesList = genericJsModules.concat(json.parse.modules, json.parse.modulescripts)
                    ...
                    styleDependenciesList = json.parse.modules.concat(json.parse.modulestyles)
