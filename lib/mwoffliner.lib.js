                    ...
                    if (jsDependenciesList.length !== 0) {
                        jsDependenciesList.forEach(oneJsModule => {
                            ...
                            if (!fs.existsSync(jsModuleUri)) {
                                // if it has not been downloaded, download it and save it in the tmp/'filenameRadical'/j/js_module/'module.name'.js file
                    ...
                    if (styleDependenciesList.length !== 0) {
                        styleDependenciesList.forEach(oneCssModule => {
                            ...
                            if (!fs.existsSync(styleModuleUri)) {
                                // if it has not been downloaded, download it and save it in the tmp/'filenameRadical'/s/css_module/'module.name'.js file
