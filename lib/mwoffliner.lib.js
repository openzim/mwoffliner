    ...
    __ARTICLE_JS_LIST__
                        ...
                        function (dump, finished) {
                            ...
                            async.series(
                                [
                                    ...
                                    function (finished) { buildForMobile ? saveStaticFiles(finished) : finished() },
        ...
        function saveStaticFiles(finished) {
            try {
                ...
                console.log('Could not create content.parsoid.css file : ', error)
            }
            ...
            try {
                ...
                console.log('Could not create mobile.css file : ', error)
            }
