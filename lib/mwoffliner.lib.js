...
var libzim_object_wrapper_1 = require("libzim-object-wrapper");
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            zimCreator = new libzim_object_wrapper_1.ZimCreator(outZim, {});
            ...
            var cssPromises = config_1.default.output.cssResources
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            cssCont = _a.sent();
                            return [4 /*yield*/, zimCreator.addArticle(cssPath(css).replace('s/', ''), cssCont, 's')];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 4];
                        case 3:
            ...
            var jsPromises = config_1.default.output.jsResources.map(function (js) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            jsCont = _a.sent();
                            return [4 /*yield*/, zimCreator.addArticle(jsPath(js).replace('j/', ''), jsCont, 'j')];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 4];
                        case 3:
                ...
                function storeDependencies(parsoidDoc, articleId, finished) {
                    ...
                    node_fetch_1.default(articleApiUrl, {
                        ...
                        return __awaiter(_this, void 0, void 0, function () {
                            var allDependenciesWithType, scriptTags, regex, i, e_1;
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, zimCreator.addArticle(jsPath('jsConfigVars').replace('j/', ''), jsConfigVars, 'j')];
                                    case 2:
                                        // fs.writeFileSync(pathParser.resolve(env.htmlRootPath, jsPath('jsConfigVars')), jsConfigVars);
                                        _c.sent();
                                        return [3 /*break*/, 4];
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 1:
                                                ...
                                                return [4 /*yield*/, zimCreator.addArticle(articleId_1, text, type === 'js' ? 'j' : 's')];
                                            case 2:
                                                _a.sent();
        ...
        function saveStylesheet(zimCreator) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                var downloadCSSQueue = async_1.default.queue(function (link, finished) { return __awaiter(_this, void 0, void 0, function () {
                    var cssUrl, linkMedia, cssUrlRegexp, content, body, rewrittenCss, match, url, filePathname, filename, cssContent, err_3;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 6, , 7]);
                            ...
                            case 3:
                                cssContent = _a.sent();
                                return [4 /*yield*/, zimCreator.addArticle("style.css", cssContent, 's')];
                            case 4:
                                _a.sent();
                                finished();
                                _a.label = 5;
