        ...
        function saveArticles(dump, finished) {
            ...
            function treatMedias(parsoidDoc, articleId, finished) {
                ...
                videos.forEach(videoEl => {
                    ...
                    //Borrowing nopic (probably don't want videos either)
                    const shouldSaveVideo = !nopic && videoSources.length;
                    ...
                    function byWidthXHeight(a, b) { 
                        ...
                        const aWidth = a.getAttribute('data-file-width') || 0;
                        const aHeight = a.getAttribute('data-file-height') || 0;
                        const bWidth = b.getAttribute('data-file-width') || 0;
                        const bHeight = b.getAttribute('data-file-height') || 0;
