        ...
        function getArticleIds(redirectQueue) {
            ...
            function parseAPIResponse(body) {
                ...
                if (entries) {
                    ...
                    console.log("redirectQueueValues: " + redirectQueueValues_1.length);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                                    ...
                                    if (!JSON.parse(body).error) {
                                        ...
                                        for (_i = 0, pageIds_1 = pageIds; _i < pageIds_1.length; _i++) {
                                            ...
                                            for (_c = 0, _redirects_1 = _redirects; _c < _redirects_1.length; _c++) {
                                                ...
                                                console.log(title_2 + " redirects to " + originalArticleId, fromXTo);
                    ...
                    dumpTmpDir = path.join(zim.tmpDirectory, env.computeFilenameRadical(), "" + dumpId);
                    _a.label = 5;
                case 5:
                    _a.trys.push([5, 7, , 8]);
