...
var ZimCreatorFs_1 = require("./ZimCreatorFs");
...
function execute(argv) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        function doDump(env, dump) {
            return __awaiter(this, void 0, void 0, function () {
                var outZim, zimCreatorConstructor, zimCreator;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            outZim = path.resolve(zim.outputDirectory, env.computeFilenameRadical() + '.zim');
                            logger.log("Writing zim to [" + outZim + "]");
                            zimCreatorConstructor = env.nozim ? ZimCreatorFs_1.ZimCreatorFs : libzim_binding_1.ZimCreator;
                            zimCreator = new zimCreatorConstructor(outZim, {
        ...
        function saveFavicon(zimCreator) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    if (customZimFavicon) {
                        return [2 /*return*/, resizeFavicon(zimCreator, customZimFavicon)];
                    }
                    else {
                ...
                case 12:
                    ...
                    redirectQueue = async_1.default.cargo(function (articleIds, finished) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_e) {
                            switch (_e.label) {
                                case 0:
                                    articleIds = articleIds.filter(function (id) { return id.trim(); });
