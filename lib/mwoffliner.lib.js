    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        function getMainPage() {
            ...
            function createMainPage() {
                ...
                var articlesWithImagesEl;
                var articlesWithoutImagesEl;
                if (articlesWithImages.length > 10) {
                    articlesWithImagesEl = articlesWithImages.map(function (article) { return U.makeArticleImageTile(env, article); }).join('\n');
                }
                else {
                    articlesWithoutImagesEl = allArticles.map(function (article) { return U.makeArticleListItem(env, article); }).join('\n');
                }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    /* ********************************* */
                    _a.sent();
                    if (!(zim.articleList && zim.articleList.includes('http'))) return [3 /*break*/, 8];
                ...
                case 6:
                    ...
                    return [4 /*yield*/, new Promise(function (resolve, reject) {
                            articleListContentStream_1
                                .on('error', function (err) { return reject({ message: "Failed to download article list from [" + zim.articleList + "]", error: err }); })
                                .on('end', resolve)
                ...
                case 7:
                    ...
                    _a.label = 8;
                case 8: return [4 /*yield*/, mw.getTextDirection(env, downloader)];
                case 9:
                    _a.sent();
                ...
                case 13:
                    _a.sent();
                    if (!useCache) return [3 /*break*/, 15];
                    return [4 /*yield*/, zim.prepareCache()];
                case 14:
                    _a.sent();
                    _a.label = 15;
                case 15: return [4 /*yield*/, env.checkResume()];
                case 16:
                    _a.sent();
                    return [4 /*yield*/, getArticleIds(redirectQueue)];
                case 17:
                    _a.sent();
                    if (!useCache) return [3 /*break*/, 19];
                    return [4 /*yield*/, cacheRedirects()];
                case 18:
                    _a.sent();
                    _a.label = 19;
                case 19: return [4 /*yield*/, Utils_1.doSeries(env.dumps.map(function (dump) {
                ...
                case 20:
                    ...
                    if (!(!useCache || skipCacheCleaning)) return [3 /*break*/, 22];
                ...
                case 23:
                    _a.sent();
                    _a.label = 24;
                case 24: return [4 /*yield*/, redis.flushDBs()];
                case 25:
                    _a.sent();
