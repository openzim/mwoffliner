...
module.exports = {
    getParametersList: () => [
        ...
        { name: 'buildForMobile', description: 'Build html optimised for mobile use', required: false }
    ],
...
<div style="clear:both; background-image:linear-gradient(180deg, #E8E8E8, white); border-top: dashed 2px #AAAAAA; padding: 0.5em 0.5em 2em 0.5em; margin-top: 1em; direction: ltr;">
    ...
    Additional terms may apply for the media files.
        ...
        const buildForMobile = argv.buildForMobile || false
        ...
        const genericCssModules = buildForMobile
        ...
        if (buildForMobile) htmlTemplateCode = `
<!DOCTYPE html>
<html class='client-js'>
  <head>
    ...
    <link href="${styleDirectory}/${styleModulesDirectory}/kiwix_mobile.css" rel="stylesheet" type="text/css" />
  ...
  <body class="mediawiki ltr sitedir-ltr mw-hide-empty-elt ns-0 ns-subject page-Lyon rootpage-Lyon stable skin-minerva action-view animations">
    ...
    <script>
      ...
      function kiwixToggleOpenSection(id) {
...
<html>
  ...
  <body class="mw-body mw-body-content mediawiki" style="background-color: white; margin: 0; border-width: 0px; padding: 0px;">
    ...
    __ARTICLE_JS_LIST__
                        ...
                        function (dump, finished) {
                            ...
                            async.series(
                                [
                                    ...
                                    function (finished) { buildForMobile ? saveStaticKiwixFiles(finished) : finished() },
        ...
        function saveStaticKiwixFiles(finished) {
            try {
                ...
                console.log('Could not create kiwix_mobile.css file : ', error)
            }

            try {
                fs.readFile('./kiwix_mobile.css', (err, data) =>
                    fs.writeFile(`./${tmpDirectory}${filenameRadical}/${styleDirectory}/${styleModulesDirectory}/kiwix_mobile.css`, data)
                )
            } catch (error) {
                console.log('Could not create kiwix_mobile.css file : ', error)
            }
            ...
            try {
                ...
                console.log('Could not create inserted_style_mobile.css file : ', error)
                finished()
            }
        }
        ...
        function saveArticles(finished) {
            ...
            function storeDependencies(parsoidDoc, articleId, finished) {
                ...
                const downloadAndSaveModule = (module, type) => {
                    ...
                    .then(redisResult => redisResult === 1 && fetch(encodeURI(`${mwUrl}w/load.php?debug=false&lang=en&modules=${module}&only=${apiParameterOnly}&skin=vector&version=&*`), {
                            method: 'GET',
            ...
            function saveArticle(articleId, finished) {
                ...
                let html = ''
                if (buildForMobile) {
                    // from here, we do not use the html from parsoid but from the rest api
                    fetch(encodeURI(`https://fr.wikipedia.org/api/rest_v1/page/mobile-sections/${articleId}`), {
                        method: 'GET',
                        headers: { 'Accept': 'application/json' }
                    })
                    .then(response => response.json())
                    .then(json => {
                        ...
                        html += `
                            <h1
                                ...
                                onClick="kiwixToggleOpenSection(0)"
                            >
                        ...
                        json.remaining.sections.forEach((oneSection, i) => html += `
                            <h2
                                ...
                                onClick="kiwixToggleOpenSection(${oneSection.id})"
                            >
                                <div class="mw-ui-icon mw-ui-icon-arrow mw-ui-icon-element  indicator" title=""></div>
