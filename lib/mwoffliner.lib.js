                        ...
                        function( dump, finished ) {
                            ...
                            async.series(
                                [
                                    ...
                                    function( finished ) { saveStaticKiwixFiles( finished ) },
                    ...
                    if ( parsoidContentType == 'json' ) {
                        ...
                        if ( json['visualeditor'] ) {
                            ...
                            .then(json => {
                              ...
                              json.remaining.sections.forEach(oneSection => html += `
                                <h2
                                  class="section-heading in-block collapsible-heading" tabindex="0" aria-haspopup="true" aria-controls="content-collapsible-block-0"
