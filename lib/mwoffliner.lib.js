    ...
    __ARTICLE_JS_LIST__
        ...
        function saveArticles(dump, finished) {
            ...
            function applyOtherTreatments(parsoidDoc, articleId, finished) {
                ...
                deleteNodes(
                    parsoidDoc.getElementsByClassName('gallerybox'),
                    function(gb) {
                        return !gb.getElementsByClassName('thumb').length || nopic;
                    }
                );

                /* Remove "map" tags if necessary */
                if (nopic) {
                    deleteNodes(parsoidDoc.getElementsByTagName('map'));
                }
                ...
                cssClassBlackList.map(function (classname) {
                    deleteNodes(parsoidDoc.getElementsByClassName(classname));
                });
                ...
                cssClassBlackListIfNoLink.map(function (classname) {
                    deleteNodes(
                        parsoidDoc.getElementsByClassName(classname),
                        function(n) {
                ...
                deleteNodes(parsoidDoc.getElementsByTagName('input'));
        ...
        function deleteNodes(nodes, filter) {
            for (var i = 0; i < nodes.length; i++) {
