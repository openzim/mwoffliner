        ...
        function saveStylesheet() {
            ...
            return new Promise(function (resolve, reject) {
                ...
                var downloadCSSQueue = async_1.default.queue(function (link, finished) { return __awaiter(_this, void 0, void 0, function () {
                    var cssUrl, linkMedia, cssUrlRegexp, content, body, rewrittenCss, match, url, filePathname, filename, err_4;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 4, , 5]);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    dumpTmpDir = path.join(zim.tmpDirectory, "" + dumpId);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 8:
                    ...
                    redirectQueue = async_1.default.cargo(function (articleIds, finished) { return __awaiter(_this, void 0, void 0, function () {
                        var url, content, body, redirects, redirectsCount, _a, pages, normalized, fromXTo, pageIds, _i, pageIds_1, pageId, _b, _redirects, title, originalArticleId, _c, _redirects_1, redirect, title_2, err_5;
                            ...
                            switch (_d.label) {
                                ...
                                case 2:
                                    ...
                                    if (!JSON.parse(body).error) {
                                        ...
                                        pageIds = Object.keys(pages).filter(function (id) { return id !== '-1'; });
                ...
                case 9:
                    ...
                    /* ********************************* */
                    _a.sent();
                    if (!(zim.articleList && zim.articleList.includes('http'))) return [3 /*break*/, 14];
                    _a.label = 10;
                case 10:
                ...
                case 20:
                    _a.sent();
                    _a.label = 21;
                case 21: return [4 /*yield*/, env.checkResume()];
                case 22:
                    _a.sent();
                ...
                case 25:
                    _a.sent();
                    if (!(!useCache || skipCacheCleaning)) return [3 /*break*/, 27];
                ...
                case 28:
                    _a.sent();
                    _a.label = 29;
                case 29: return [4 /*yield*/, redis.flushDBs()];
                case 30:
                    _a.sent();
