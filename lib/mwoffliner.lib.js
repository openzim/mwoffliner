...
var libzim = __importStar(require("libzim"));
...
function execute(argv) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        function buildZim() {
            return __awaiter(this, void 0, void 0, function () {
                var c, TestArticle, TestArticleSource, src;
                return __generator(this, function (_a) {
                    c = new libzim.writer.ZimCreator();
                    TestArticle = /** @class */ (function (_super) {
                        __extends(TestArticle, _super);
                        function TestArticle(id) {
                            var _this = _super.call(this) || this;
                            _this._id = '' + id;
                            // tslint:disable-next-line:no-bitwise
                            _this._compress = ((id & 1) === 1);
                            _this._param = [id, 0xFFFFFFFF, Math.pow(2, 32),
                                Math.pow(2, 52), Math.pow(2, 53)];
                            var data = 'this is article ' + id + '\n';
                            while (data.length < 512) {
                                data += Math.random() + '\n';
                            }
                            _this._data = new Buffer(data, 'utf8');
                            return _this;
                        }
                        TestArticle.prototype.getAid = function () { return this._id; };
                        TestArticle.prototype.getNamespace = function () { return 'A'; };
                        TestArticle.prototype.getUrl = function () { return this._id; };
                        TestArticle.prototype.getTitle = function () { return this._id; };
                        TestArticle.prototype.isRedirect = function () { return false; };
                        TestArticle.prototype.getMimeType = function () { return 'text/plain'; };
                        TestArticle.prototype.getRedirectAid = function () { return ''; };
                        TestArticle.prototype.getParameter = function () { return libzim.ZIntStream.toBuffer(this._param); };
                        TestArticle.prototype.shouldCompress = function () { return this._compress; };
                        TestArticle.prototype.getData = function () {
                            return new libzim.Blob(this._data);
                        };
                        return TestArticle;
                    }(libzim.writer.Article));
                    TestArticleSource = /** @class */ (function (_super) {
                        __extends(TestArticleSource, _super);
                        function TestArticleSource(max, szfunc) {
                            var _this = _super.call(this) || this;
                            var maxx = (max === undefined) ? 16 : max;
                            _this._next = 0;
                            _this._articles = [];
                            _this.getCurrentSize = szfunc;
                            for (var n = 0; n < maxx; n++) {
                                _this._articles[n] = new TestArticle(n + 1);
                            }
                            return _this;
                        }
                        TestArticleSource.prototype.getNextArticle = function () {
                            console.log('After ' + this._next + ' articles:', this.getCurrentSize(), 'bytes');
                            return this._articles[this._next++];
                        };
                        TestArticleSource.prototype.getUuid = function () {
                            var uuid = libzim.Uuid.generate();
                            console.log('Generating UUID: ' + uuid);
                            return uuid;
                        };
                        return TestArticleSource;
                    }(libzim.writer.ArticleSource));
                    src = new libzim.writer.ArticleSource();
                    src.getCurrentSize = function () { return c.getCurrentSize(); };
                    src.articles = [];
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, saveStaticFiles()];
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, saveStylesheet()];
                        case 3:
                            _a.sent();
                            return [4 /*yield*/, saveFavicon()];
                        case 4:
                            _a.sent();
                            if (!articleList) return [3 /*break*/, 6];
                            return [4 /*yield*/, getArticleThumbnails()];
                        case 5:
                            _a.sent();
                            _a.label = 6;
                        case 6: return [4 /*yield*/, getMainPage()];
                        case 7:
                            _a.sent();
                            if (!env.writeHtmlRedirects) return [3 /*break*/, 9];
                            return [4 /*yield*/, saveHtmlRedirects()];
                        case 8:
                            _a.sent();
                            _a.label = 9;
                        case 9: return [4 /*yield*/, saveArticles(dump)];
                        case 10:
                            _a.sent();
                            return [4 /*yield*/, drainDownloadFileQueue()];
                        case 11:
                            _a.sent();
                            return [4 /*yield*/, drainOptimizationQueue(optimizationQueue)];
                        case 12:
                            _a.sent();
                            // await zim.buildZIM();
                            return [4 /*yield*/, buildZim()];
                        case 13:
                            // await zim.buildZIM();
                            _a.sent();
        ...
        function getArticleThumbnails() {
            ...
            return new Promise(function (resolve, reject) {
                ...
                async_1.default.whilst(function () { return articleIndex < articleListLines.length - 1 && fetchedThumbnails < 100; }, function (callback) { return __awaiter(_this, void 0, void 0, function () {
                    var articleTitle, articleId, url, imageUrl, resp, err_2, internalSrc;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                            ...
                            case 3:
                                err_2 = _a.sent();
                                logger.warn("Failed to get thumbnail url for article [" + articleId + "]: " + err_2.message);
        ...
        function saveStylesheet() {
            ...
            return new Promise(function (resolve, reject) {
                ...
                var downloadCSSQueue = async_1.default.queue(function (link, finished) { return __awaiter(_this, void 0, void 0, function () {
                    var cssUrl, linkMedia, cssUrlRegexp, content, body, rewrittenCss, match, url, filePathname, filename, err_3;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 4, , 5]);
            ...
            redis.getMedia(filenameBase, function (error, rWidth) {
                ...
                if (error || !rWidth || rWidth < width) {
                    ...
                    redis.saveMedia(filenameBase, width, function () {
                        ...
                        if (toDownload) {
                            if (useCache) {
                                downloader.downloadMediaFile(url, cachePath, true, optimizationQueue).then(function () {
                                ...
                                downloader.downloadMediaFile(url, mediaPath, true, optimizationQueue).then(callback, function (error) { return callback({ message: 'Failed to write file', error: error }); });
                            }
                        }
                        else {
        ...
        function saveFavicon() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                var faviconPath, faviconIsRemote, content;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            logger.log('Saving favicon.png...');
                            if (!customZimFavicon) return [3 /*break*/, 4];
                            faviconPath = env.htmlRootPath + 'favicon.png';
                            faviconIsRemote = customZimFavicon.includes('http');
                            content = void 0;
                            if (!faviconIsRemote) return [3 /*break*/, 2];
                            logger.log("Downloading remote zim favicon from [" + customZimFavicon + "]");
                            return [4 /*yield*/, axios_1.default.get(customZimFavicon, { responseType: 'arraybuffer' }).then(function (a) { return a.data; })];
                        case 1:
                            content = _a.sent();
                            return [3 /*break*/, 3];
                        case 2:
                        ...
                        case 3:
                            ...
                            return [2 /*return*/, resizeFavicon(faviconPath)];
                        case 4: return [2 /*return*/, downloader.downloadContent(mw.siteInfoUrl())
                                .then(function (_a) {
                                var content = _a.content;
                                return __awaiter(_this, void 0, void 0, function () {
                                    var body, entries, parsedUrl, ext, faviconPath, faviconFinalPath, logoUrl;
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            case 0:
                                                ...
                                                return [4 /*yield*/, downloader.downloadMediaFile(logoUrl, faviconPath, true, optimizationQueue)];
                                            case 1:
                                                _b.sent();
                                                if (!(ext !== 'png')) return [3 /*break*/, 3];
                                            ...
                                            case 2:
                                                _b.sent();
                                                _b.label = 3;
                                            case 3: return [2 /*return*/, resizeFavicon(faviconFinalPath)];
                                        }
                                    });
                                });
                            })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    /* ZIM custom Favicon */
                    if (customZimFavicon && !(customZimFavicon.includes('http') || fs_1.default.existsSync(customZimFavicon))) {
                ...
                case 4:
                    ...
                    redirectQueue = async_1.default.cargo(function (articleIds, finished) { return __awaiter(_this, void 0, void 0, function () {
                        var articleId, url, content, body, redirects, redirectsCount, _a, pages, normalized, fromXTo, pageIds, _i, pageIds_1, pageId, redirects_2, _b, redirects_1, entry, originalArticleId, title, err_4;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    ...
                                    url = mw.backlinkRedirectsQueryUrl(articleIds);
                                    _c.label = 1;
                                case 1:
                                    _c.trys.push([1, 3, , 4]);
                                ...
                                case 2:
                                    ...
                                    if (!JSON.parse(body).error) {
                                        redirects = {};
                                        redirectsCount = 0;
                                        _a = JSON.parse(body).query, pages = _a.pages, normalized = _a.normalized;
                                        ...
                                        for (_i = 0, pageIds_1 = pageIds; _i < pageIds_1.length; _i++) {
                                            pageId = pageIds_1[_i];
                                            redirects_2 = pages[pageId].redirects;
                                            for (_b = 0, redirects_1 = redirects_2; _b < redirects_1.length; _b++) {
                                                entry = redirects_1[_b];
                                                originalArticleId = fromXTo[entry.title];
                                                title = entry.title.replace(/ /g, mw.spaceDelimiter);
                                                redirects_2[title] = originalArticleId;
                                                redirectsCount += 1;
                ...
                case 5:
                    ...
                    /* ********************************* */
                    _a.sent();
                    if (!(zim.articleList && zim.articleList.includes('http'))) return [3 /*break*/, 10];
                    _a.label = 6;
                case 6:
                    _a.trys.push([6, 9, , 10]);
                    tmpArticleListPath = path.join(zim.tmpDirectory, 'articleList');
                ...
                case 9:
                    err_1 = _a.sent();
                    logger.error("Failed to download article list from [" + zim.articleList + "]", err_1);
                    throw err_1;
                case 10:
                    try {
                ...
                case 15:
                    _a.sent();
                    if (!useCache) return [3 /*break*/, 17];
                    return [4 /*yield*/, zim.prepareCache()];
                case 16:
                    _a.sent();
                    _a.label = 17;
                case 17: return [4 /*yield*/, env.checkResume()];
                case 18:
                    _a.sent();
                    return [4 /*yield*/, getArticleIds(redirectQueue)];
                case 19:
                    _a.sent();
                    if (!useCache) return [3 /*break*/, 21];
                    return [4 /*yield*/, cacheRedirects()];
                case 20:
                    _a.sent();
                    _a.label = 21;
                case 21: return [4 /*yield*/, Utils_1.doSeries(env.dumps.map(function (dump) {
                ...
                case 22:
                    ...
                    if (articleList && articleList.includes('http')) {
                        ...
                        fs_1.unlinkSync(zim.articleList);
                    }
                    if (!(!useCache || skipCacheCleaning)) return [3 /*break*/, 24];
                ...
                case 25:
                    _a.sent();
                    _a.label = 26;
                case 26: return [4 /*yield*/, redis.flushDBs()];
                case 27:
                    _a.sent();
