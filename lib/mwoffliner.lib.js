...
function execute(argv) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        function saveArticles(dump) {
            return new Promise(function (resolve, reject) {
                ...
                function saveArticle(articleId, finished) {
                    var html = '';
                    var isMainPage = zim.mainPageId === articleId;
                    if (isMainPage) {
        ...
        var _speed, adminEmail, localParsoid, customZimFavicon, verbose, minifyHtml, skipHtmlCache, skipCacheCleaning, keepEmptyParagraphs, mwUrl, mwWikiPath, mwApiPath, mwDomain, mwUsername, mwPassword, requestTimeout, publisher, articleList, customMainPage, customZimTitle, customZimDescription, customZimTags, cacheDirectory, outputDirectory, tmpDirectory, withZimFullTextIndex, format, filenamePrefix, keepHtml, resume, deflateTmpHtml, writeHtmlRedirects, _addNamespaces, parsoidUrl, cpuCount, speed, logger, mw, downloader, creator, zimOpts, zim, env, INFINITY_WIDTH, articleIds, webUrlHost, parsoidContentType, addNamespaces, redis, dirs, cssLinks, jsScripts, redirectTemplate, footerTemplate, leadSectionTemplate, sectionTemplate, subSectionTemplate, genericJsModules, genericCssModules, mediaRegex, htmlTemplateCode, optimizationQueue, downloadFileQueue, redirectQueue;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
