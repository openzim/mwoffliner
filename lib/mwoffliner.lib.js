    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        function doDump(env, dump) {
            ...
            return Utils_1.doSeries([
                ...
                zim.mobileLayout ? function () { return saveStaticFiles(); } : null,
        ...
        function saveHtmlRedirects() {
            return new Promise(function (resolve, reject) {
                ...
                redis.processAllRedirects(speed, saveHtmlRedirect, 'Unable to save a HTML redirect', 'All redirects were saved successfuly as HTML files.').then(resolve, reject);
            });
        }
                    ...
                    function rewriteUrl(linkNode, finished) {
                        ...
                        if (!href) {
                            ...
                            if (rel) { // This is Parsoid HTML
                                ...
                                U.exitIfError(!href, "No href attribute in the following code, in article " + articleId + "\n" + linkNode.outerHTML);
        ...
        function saveStylesheet() {
            return new Promise(function (resolve, reject) {
                ...
                var downloadCSSQueue = async_1.default.queue(function (link, finished) {
                    ...
                    var cssUrl = typeof link === 'object' ? U.getFullUrl(webUrlHost, link.getAttribute('href')) : link;
                        ...
                        if (fs_1.default.existsSync(cacheHeadersPath) && fs_1.default.existsSync(cachePath)) {
                            ...
                            if (!responseHeaders || responseHeaders.width < width) {
                                ...
                                fs_1.default.symlink(cachePath, mediaPath, 'file', function (error) {
                                    if (error) {
                                        U.exitIfError(error.code !== 'EEXIST', "Unable to create symlink to " + mediaPath + " at " + cachePath + ": " + error);
                        ...
                        if (toDownload) {
                            downloader.downloadMediaFile(url, cachePath, true, optimizationQueue, function (error) {
                                if (error) {
                                    ...
                                    fs_1.default.symlink(cachePath, mediaPath, 'file', function (error) {
                                        U.exitIfError(error && error.code !== 'EEXIST', "Unable to create symlink to " + mediaPath + " at " + cachePath + ": " + error);
        ...
        var _speed, adminEmail, localParsoid, customZimFavicon, verbose, minifyHtml, skipHtmlCache, skipCacheCleaning, keepEmptyParagraphs, mwUrl, mwWikiPath, mwApiPath, mwDomain, mwUsername, mwPassword, requestTimeout, publisher, articleList, customMainPage, customZimTitle, customZimDescription, customZimTags, cacheDirectory, mobileLayout, outputDirectory, tmpDirectory, withZimFullTextIndex, format, filenamePrefix, keepHtml, resume, deflateTmpHtml, writeHtmlRedirects, _addNamespaces, parsoidUrl, cpuCount, speed, logger, mw, downloader, creator, zimOpts, zim, env, INFINITY_WIDTH, articleIds, webUrlHost, parsoidContentType, addNamespaces, redis, dirs, cssLinks, jsScripts, redirectTemplate, footerTemplate, leadSectionTemplate, sectionTemplate, subSectionTemplate, genericJsModules, genericCssModules, mediaRegex, htmlMobileTemplateCode, htmlDesktopTemplateCode, optimizationQueue, downloadFileQueue, redirectQueue;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    /* ZIM custom Favicon */
                    U.exitIfError(customZimFavicon && !fs_1.default.existsSync(customZimFavicon), "Path " + customZimFavicon + " is not a valid PNG file.");
                    ...
                    addNamespaces = _addNamespaces ? String(_addNamespaces).split(',') : [];
                    if (!parsoidUrl) {
                        if (localParsoid) {
                ...
                case 1:
                    ...
                    genericCssModules = zim.mobileLayout ? config_1.default.output.mw.css.mobile : config_1.default.output.mw.css.desktop;
                    mediaRegex = /^(.*\/)([^/]+)(\/)(\d+px-|)(.+?)(\.[A-Za-z0-9]{2,6}|)(\.[A-Za-z0-9]{2,6}|)$/;
                    htmlMobileTemplateCode = readTemplate(config_1.default.output.templates.mobile)
                        .replace('__CSS_LINKS__', cssLinks)
                        .replace('__JS_SCRIPTS__', jsScripts);
                    htmlDesktopTemplateCode = readTemplate(config_1.default.output.templates.desktop);
                    ...
                    redirectQueue = async_1.default.queue(function (articleId, finished) {
                        if (articleId) {
                ...
                case 8:
                    _a.sent();
                    return [4 /*yield*/, env.checkResume()];
                case 9:
                    _a.sent();
                ...
                case 12:
                    _a.sent();
                    if (!skipCacheCleaning) return [3 /*break*/, 14];
                ...
                case 15:
                    _a.sent();
                    _a.label = 16;
                case 16: return [4 /*yield*/, redis.flushDBs()];
                case 17:
                    _a.sent();
