            ...
            switch (_a.label) {
                ...
                case 4:
                    ...
                    redirectQueue = async_1.default.cargo(function (articleIds, finished) { return __awaiter(_this, void 0, void 0, function () {
                        var articleId, url, content, body, redirects, redirectsCount, _a, pages, normalized, fromXTo, pageIds, _i, pageIds_1, pageId, redirects_2, _b, redirects_1, entry, originalArticleId, title, err_5;
                ...
                case 24:
                    _a.sent();
                    _a.label = 25;
                case 25: return [4 /*yield*/, Utils_1.doSeries(env.dumps.map(function (dump) {
                        return function () { return doDump(env, dump); };
                    }))];
                case 26:
                    _a.sent();
                    logger.log("Deleting tmp dump dir [" + dumpTmpDir + "]");
                    rimraf_1.default(dumpTmpDir);
                    if (!(!useCache || skipCacheCleaning)) return [3 /*break*/, 28];
                ...
                case 29:
                    _a.sent();
                    _a.label = 30;
                case 30: return [4 /*yield*/, redis.flushDBs()];
                case 31:
                    _a.sent();
