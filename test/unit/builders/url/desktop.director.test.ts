...
describe('WikimediaDesktopURLDirector', () => {
  const wikimediaDesktopUrlDirector = new WikimediaDesktopURLDirector('https://en.wikipedia.org/api/rest_v1/page/html/')
  ...
  describe('buildArticleURL', () => {
    it('should return the URL to retrieve a desktop article', () => {
      ...
      expect(url).toBe('https://en.wikipedia.org/api/rest_v1/page/html/article-1234')
    })
  })
})
