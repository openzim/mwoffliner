...
_test('Downloader class with optimisation', async (t) => {
    ...
    setTimeout(async function(){
        ...
        t.equal(downloader.checkAndReplaceWeakEtag(resp.headers.etag), downloader.checkAndReplaceWeakEtag(imageContent.Metadata.etag), 'Etag Matched from online Mediawiki and S3');
        ...
        t.equal(downloader.checkAndReplaceWeakEtag(updatedImage.Metadata.etag),  downloader.checkAndReplaceWeakEtag(resp.headers.etag), 'Image refreshed with proper Etag');
    }, 5000)
});
