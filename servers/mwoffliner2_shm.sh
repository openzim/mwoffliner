...
# Wikipedia
$MWMATRIXOFFLINER --project=wiki --outputDirectory=$ZIM2INDEX/wikipedia/ --language="(ar|bg|cs|da|et|el|eo|eu|fi|gl|he|hy|hi|hr|id|kk|lt|la|ms|min|nn|no|simple|sk|sl|sr|uk|uz|tr|vo)"