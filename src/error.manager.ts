...
const matchingRules: MatchingRule[] = [
  ...
  },
  {
    ...
    responseIsEmpty: false,
    rawResponseDataContains: null,
    jsonResponseDataContains: [{ key: 'error.code', valueContains: ['permissiondenied'] }],
    detailsMessageKey: 'PERMISSION_DENIED',
    displayThirdLine: false,
    isHardFailure: false,
  },
  {
    name: 'category lockdown error',
    errorCodes: null,
    urlContains: null,
    httpReturnCodes: null,
    contentTypes: null,
    responseIsEmpty: false,
    rawResponseDataContains: null,
    jsonResponseDataContains: [{ key: 'error.code', valueContains: ['categorylockdown'] }],
    detailsMessageKey: 'CATEGORY_LOCKDOWN',
    displayThirdLine: false,
    isHardFailure: false,
  },
  {
